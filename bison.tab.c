...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_F_READ = 3,                     /* F_READ  */
  YYSYMBOL_F_WRITE = 4,                    /* F_WRITE  */
  YYSYMBOL_SET = 5,                        /* SET  */
  YYSYMBOL_MOV_IN = 6,                     /* MOV_IN  */
  YYSYMBOL_MOV_OUT = 7,                    /* MOV_OUT  */
  YYSYMBOL_F_TRUNCATE = 8,                 /* F_TRUNCATE  */
  YYSYMBOL_F_SEEK = 9,                     /* F_SEEK  */
  YYSYMBOL_CREATE_SEGMENT = 10,            /* CREATE_SEGMENT  */
  YYSYMBOL_IO = 11,                        /* IO  */
  YYSYMBOL_WAIT = 12,                      /* WAIT  */
  YYSYMBOL_SIGNAL = 13,                    /* SIGNAL  */
  YYSYMBOL_F_OPEN = 14,                    /* F_OPEN  */
  YYSYMBOL_F_CLOSE = 15,                   /* F_CLOSE  */
  YYSYMBOL_DELETE_SEGMENT = 16,            /* DELETE_SEGMENT  */
  YYSYMBOL_EXIT = 17,                      /* EXIT  */
  YYSYMBOL_YIELD = 18,                     /* YIELD  */
  YYSYMBOL_NEWLINE = 19,                   /* NEWLINE  */
  YYSYMBOL_ID = 20,                        /* ID  */
  YYSYMBOL_CONSTANTE = 21,                 /* CONSTANTE  */
  YYSYMBOL_YYACCEPT = 22,                  /* $accept  */
  YYSYMBOL_programa = 23,                  /* programa  */
  YYSYMBOL_listasentencia = 24,            /* listasentencia  */
  YYSYMBOL_sentencias = 25,                /* sentencias  */
  YYSYMBOL_sentencia1 = 26,                /* sentencia1  */
  YYSYMBOL_sentencia2 = 27,                /* sentencia2  */
  YYSYMBOL_sentencia3 = 28                 /* sentencia3  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "F_READ", "F_WRITE",
  "SET", "MOV_IN", "MOV_OUT", "F_TRUNCATE", "F_SEEK", "CREATE_SEGMENT",
  "IO", "WAIT", "SIGNAL", "F_OPEN", "F_CLOSE", "DELETE_SEGMENT", "EXIT",
  "YIELD", "NEWLINE", "ID", "CONSTANTE", "$accept", "programa",
  "listasentencia", "sentencias", "sentencia1", "sentencia2", "sentencia3", YY_NULLPTR
};
